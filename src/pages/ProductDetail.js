            ...
            <div className="pt-6 text-left" >
                ...
                <div className="mx-auto max-w-2xl px-4 pt-10 pb-16 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pt-16 lg:pb-24">
                    ...
                    <div className="mt-4 lg:row-span-3 lg:mt-0">
                        <h2 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl"> Người bán</h2>

                        {/* Name */}
                        <div className="mt-10">
                            <div className="flex items-center justify-between">
                                <h3 className="text-lg font-medium text-gray-900">{postedBy.username}</h3>
                                <button href="#" className="px-6 py-2 text-white bg-yellow-500 rounded-full hover:bg-yellow-300 hover:text-red-100">
                                    Xem cửa hàng
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pt-6 lg:pb-16 lg:pr-8">
                        ...
                        <div className="mt-10">
                            <div className="flex items-center justify-between">
                                <p className=" text-red-600 text-3xl tracking-tight text-gray-900">{product.price}</p>
                                <a href="/save" className="flex flex-col items-center text-lg font-medium text-indigo-600 hover:text-indigo-500">
                        ...
                        <div className="mt-10">
                            ...
                            <div className="mt-4">
                                <p className="text-base leading-4 mt-4 text-gray-600">Ngày đăng: {product.datePosted}</p>
                                <p className="text-base leading-4 mt-4 text-gray-600">Hãng SX: {product.branchName}</p>
                                <p className="text-base leading-4 mt-4 text-gray-600">Năm SX: {product.year}</p>
                                <p className="text-base leading-4 mt-4 text-gray-600">Bảo hành: {product.warranty}</p>
                            </div>
                        </div>
