            ...
            <div className="pt-6 text-left" >
                <nav aria-label="Breadcrumb">
                    <ol role="list" className="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                        ...
                        <li className="text-sm">
                            <a href={post.href} aria-current="page" className="font-medium text-gray-500 hover:text-gray-600">
                                {post.title}
                            </a>
                        </li>
                    </ol>
                ...
                <div className="mx-auto max-w-2xl px-4 pt-10 pb-16 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pt-16 lg:pb-24">
                    ...
                    <div className="mt-4 lg:row-span-3 lg:mt-0">
                        ...
                        <div className="mt-10">
                            <div className="flex items-center justify-between">
                                <h3 className="text-lg font-medium text-gray-900">{post.postedBy.username}</h3>
                    ...
                    <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pt-6 lg:pb-16 lg:pr-8">
                        ...
                        <div className="mt-10">
                            <div className="flex items-center justify-between">
                                <p className=" text-red-600 text-3xl tracking-tight text-gray-900">{post.price}</p>
                        ...
                        <div className="mt-10">
                            ...
                            <div className="mt-4">
                                <p className="text-base leading-4 mt-4 text-gray-600">Ngày đăng: {post.datePosted}</p>
                                <p className="text-base leading-4 mt-4 text-gray-600">Hãng SX: {post.branchName}</p>
                                <p className="text-base leading-4 mt-4 text-gray-600">Năm SX: {post.year}</p>
                                <p className="text-base leading-4 mt-4 text-gray-600">Bảo hành: {post.warranty}</p>
                            </div>
                        </div>
